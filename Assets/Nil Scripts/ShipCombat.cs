...
public class ShipCombat : MonoBehaviour
{
    ...
    public AudioClip sonidoFlechas;
    ...
    void EjecutarArrowShower()
    {
        ...
        if ((alineadoHorizontal || alineadoVertical) && distanciaCeldas <= (arrowRange + 0.1f))
        {
            ...
            {
                // REPRODUCIR SONIDO
                AudioManager.Instance.PlaySFX(sonidoFlechas);

                stats.RecibirDanio(Random.Range(10f, 21f));
                movement.ConsumirMovimientos(costeReal);
            }
        }
    }
    ...
    void EjecutarRamming()
    {
        ...
        if (dist > 0.5f && dist < (spacing + 0.2f))
        {
            ...
            {
                // REPRODUCIR SONIDO
                AudioManager.Instance.PlaySFX(sonidoEmbestida);

                stats.RecibirDanio(Random.Range(10f, 26f));
